			...
			<div class="container-fluid">
                ...
                <?php foreach($data as $value){
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<?php echo $value['TieuDe'];?>" name="TieuDe">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<?php echo $value['TomTat'];?>" name="TomTat">
					</div>
					<!-- <div class="form-group">
                        <label for="file">URL hình:</label>
                        <input type="file" class="form-control" name="file">
                      </div> -->
					<input type="file" name="HinhTam" value="<?php echo $value['HinhAnh'];?>" id="file" class="inputfile" data-multiple-caption="{count} files selected"
						multiple />
					...
					<div class="form-group">
						...
						<select class="form-control" name="idTL">
							...
							<?php foreach ($data2 as $value2 ) {
								if($value2['idTL']!=$value['idTL']){
										?>
								<option value="<?php echo $value2['idTL'] ?>"	><?php echo $value2['TenTL'] ?></option>
								<?php }}?>

						</select>
					</div>
					<textarea name="NoiDung" class="ckeditor" id="ckeditor" ><?php echo $value['NoiDung'] ?>    </textarea>
                
					<div class="form-group">
                        <label for="filter">Trạng thái:</label>
                        <select class="form-control" name="TrangThai">
                        <option value="<?php echo $value['TrangThai'] ?>" selected><?php if($value['TrangThai']==1) echo 'Hiện'; else echo 'Ẩn' ?></option>
                        <?php for ($i=1; $i < 3; $i++) { 
                            ?>

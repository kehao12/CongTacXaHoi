            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                            ...
                            <div class="news_post_top d-flex flex-column flex-sm-row">
                                <div class="news_post_date_container">
                                    <div
                                        ...
                                        <div><?php $date=new DateTime($value['NgayTao']); echo date_format($date,"d")?>
                                        </div>
                                ...
                                <div class="news_post_title_container">
                                    <div class="news_post_title">
                                        <a
                                            href="?controller=index&action=chitiet&id=<?php echo $value['idBV']?>"><?php echo $value['TieuDe'] ?></a>
                                    </div>
                        ...
                        <?php }}} else { echo "Chưa có bài viết"; }?>
                        ...
                        <div class="news_page_nav">
                            ...
                            <ul>
                                ...
                                <li class=" text-center trans_200"><a
                                        href="?controller=index&action=bvtl&page=<?php echo ($current_page-1) ?>">Prev</a>
                                </li>
                                <?php } ?>
                                ...
                                <li class="active text-center trans_200"><a
                                        href="?controller=index&action=bvtl&id=<?php echo $MaTL?>&page=<?php echo $i?>"><?php echo $i?></a>
                                </li>
                                <?php } else {?>
                                <li class="text-center trans_200"><a
                                        href="?controller=index&action=bvtl&id=<?php echo $MaTL?>&page=<?php echo $i?>"><?php echo $i?></a>
